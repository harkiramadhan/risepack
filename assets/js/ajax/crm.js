...
$('#tanggal').change(function(){
    ...
    $('#sumber_id').change(function(){
        ...
        $.ajax({
            url: baseUrl + 'crm/ajax_get_last_customers',
            type: 'get',
